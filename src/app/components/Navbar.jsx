...
const Navbar = ({ darkMode, setDarkMode }) => {
  ...
  return (
    <nav className="py-10 mb-12 flex justify-between items-center relative">
      {/* Logo */}
      ...
      <div className="sm:block md:hidden z-50" onClick={toggleNav}>
        {navOpen ? (
      ...
      <ul
        className={`${
          navOpen
            ? "flex bg-teal-400 shadow-lg h-[60vh] m-4"
            : "hidden"
      ...
      >
        <li className="mb-8 md:mb-0 md:mr-5 text-xl dark:text-grey-800">
          <a
            href="#portfolio"
            onClick={toggleNav}

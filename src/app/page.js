    ...
    <div className={darkMode ? "dark" : ""}>
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900 dark:text-white select-none">
        <section className="lg:min-h-screen md:min-h-screen sm:py-1">
          ...
          <div className="text-center p-10">
            ...
            <p className="text-md py-3 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto dark:text-white">
              Hello, I'm a recent graduate with a degree in Information
              Technology, passionate about frontend development. I have a
              strong foundation in web technologies and a flair for creating
              intuitive, visually appealing user interfaces. Explore my
              portfolio to see my projects and skills in action.
            </p>
          </div>
          <div className="text-5xl flex justify-center gap-16 py-1 text-gray-600 dark:text-white">
            <a
              href="https://github.com/AdityaJani616"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/adityajani616"
              target="_blank"
              rel="noopener noreferrer"
              className="cursor-pointer hover:text-teal-500"
            >
            ...
            <a
              href="mailto:adityajani616@gmail.com"
              target="_blank"
              className="cursor-pointer hover:text-teal-500"
            >
              <AiFillMail />
        ...
        <div className="pt-10 md:pt-16 lg:pt-20">
          <Experience />
          <PortFolio className="pt-8 lg:pt-12" />
        </div>
